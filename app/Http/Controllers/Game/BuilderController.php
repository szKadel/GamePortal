...
class BuilderController extends Controller
{
    ...
    public function index():View
    {
       $result = DB::table('games')
        ...
        return view('games.Builder.list',['movies'=>$result, 'stats'=>$stats]);
    }
    ...
    public function dashboard()
    {
        ...
        return view('games.Builder.dashboard',['stats'=>$stats,'scoreCount'=>$scoreCount]);
    }
    ...
    public function show(Game $game, $id):View
    {
        ...
        return view('games.Builder.get',['movies'=>$movie[0]??[]]);
    }
